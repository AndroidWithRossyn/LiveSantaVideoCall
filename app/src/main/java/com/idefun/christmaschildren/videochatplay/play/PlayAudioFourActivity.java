...
public class PlayAudioFourActivity extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(PlayAudioFourActivity.this).loadInterstitialAd(this);
...
//
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            startActivity(new Intent(PlayAudioFourActivity.this, RejectAudioCallFourActivity.class));
        } else {
