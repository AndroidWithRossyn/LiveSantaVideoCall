...
public class PlayVideoOneActivity extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(PlayVideoOneActivity.this).loadInterstitialAd(this);
    ...
    public void onBackPressed() {
        ...
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            AppManage.getInstance(PlayVideoOneActivity.this).showInterstitialAd(PlayVideoOneActivity.this, new AppManage.MyCallback() {
                public void callbackCall() {
                    startActivity(new Intent(PlayVideoOneActivity.this, RejectVideoCallOneActivity.class));
                }
