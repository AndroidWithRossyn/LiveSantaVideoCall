...
public class PlayAudioCallActivity extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(PlayAudioCallActivity.this).loadInterstitialAd(this);
...
//
    ...
    public void onBackPressed() {
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            startActivity(new Intent(PlayAudioCallActivity.this, RejectAudioCallActivity.class));
