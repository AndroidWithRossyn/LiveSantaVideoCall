...
public class PlayAudioCallOneActivity extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(PlayAudioCallOneActivity.this).loadInterstitialAd(this);
...
//
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            startActivity(new Intent(PlayAudioCallOneActivity.this, RejectAudioCallOneActivity.class));
        } else {
