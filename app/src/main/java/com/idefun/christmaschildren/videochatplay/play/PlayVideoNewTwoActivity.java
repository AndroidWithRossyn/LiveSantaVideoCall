...
public class PlayVideoNewTwoActivity extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(PlayVideoNewTwoActivity.this).loadInterstitialAd(this);
...
//            } else if (adsdata.get(0).getCheckadVideocallbackpressInter().equals("off")) {
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            AppManage.getInstance(PlayVideoNewTwoActivity.this).showInterstitialAd(PlayVideoNewTwoActivity.this, new AppManage.MyCallback() {
                public void callbackCall() {
                    startActivity(new Intent(PlayVideoNewTwoActivity.this, RejectVideoCallTwoActivity.class));
                }
