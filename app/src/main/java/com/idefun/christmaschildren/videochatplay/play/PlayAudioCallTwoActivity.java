...
public class PlayAudioCallTwoActivity extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(PlayAudioCallTwoActivity.this).loadInterstitialAd(this);
...
//
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            AppManage.getInstance(PlayAudioCallTwoActivity.this).showInterstitialAd(PlayAudioCallTwoActivity.this, new AppManage.MyCallback() {
                public void callbackCall() {
                    startActivity(new Intent(PlayAudioCallTwoActivity.this, RejectAudioCallTwoActivity.class));
                }
